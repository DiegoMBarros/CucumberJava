...
import br.df.dmbarros.servicos.AluguelService;
...
//	@Ent�o("^a data de entrega será no dia seguinte$")
...
//		tipoAluguel = tipo;
	...
	@Entao("^a data de entrega será em (\\d+) dias?$") //O interrogação transforma o último caractere como opcional, tornando o step com "dia" ou "dias" como válido.
